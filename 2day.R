...
# is로 시작하는 함수는 확인 함수 : 결과는 논리값(T/F)
is.numeric(number) 
is.numeric(chanum)
...
str(vector1); str(vector2); str(vector3)
print(vector1); print(vector2); print(vector3)
...
v [v>5]
sum(v>5)  
# TRUE는 1, FALSE는 0으로 계산하여 TRUE의 갯수가 답이 됨.
v==5
